...
export function EyeOffIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M1.7 1.7l12.6 12.6" />
      <path d="M6.6 6.7a2 2 0 0 0 2.7 2.7" />
      <path d="M3.2 4.2C1.9 5.2 1 6.5 1 8s2.5 5 7 5c1.2 0 2.3-.25 3.2-.65M9.7 3.2C9.15 3.07 8.58 3 8 3c-.4 0-.8.03-1.2.1" />
      <path d="M12.8 5.2C13.9 6.1 14.6 7 15 8s-.5 1.6-1.3 2.5" />
    </svg>
  );
}
...
export function TrashIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 4h10M6 4V2.5h4V4M4.5 4l.5 9.5a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1L12 4" />
    </svg>
  );
}
...
export function PersonPlusIcon() {
  return (
    <svg width="15" height="15" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="6.5" cy="5.2" r="2.4" />
      <path d="M1.5 14c0-2.6 2.2-4.4 5-4.4s5 1.8 5 4.4" />
...
export function DonationPlusIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <ellipse cx="6" cy="5" rx="4" ry="2" />
      <path d="M2 5v3c0 1.1 1.8 2 4 2s4-.9 4-2V5" />
      <path d="M2 8v3c0 1.1 1.8 2 4 2s4-.9 4-2V8" />
...
export function PaperclipIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M11.5 5.5l-5 5a2 2 0 1 0 2.8 2.8l5-5a3.5 3.5 0 0 0-5-5l-5 5a5 5 0 0 0 7 7" />
    </svg>
  );
}
...
export function SpeakerOnIcon() {
  return (
    <svg width="15" height="15" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M1.5 6h2.3L7 3v10L3.8 10H1.5z" />
      <path d="M10 5.5a4 4 0 0 1 0 5M12 3.5a7 7 0 0 1 0 9" />
    </svg>
  );
}
...
export function ScanIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <rect x="4.5" y="5.5" width="7" height="5" rx="0.5" />
    </svg>
  );
}
