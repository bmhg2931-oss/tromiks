...
export default function SettingsSidebar({ children, isAdmin }: { children: React.ReactNode; isAdmin: boolean }) {
    ...
    <div className="flex gap-6 items-start flex-wrap">
      <nav className="w-56 shrink-0 bg-white border border-line rounded-xl shadow p-3 space-y-4">
        ...
        <div>
          ...
          <div className="space-y-1">
            <NavItem href="/settings/branding" active={pathname === "/settings/branding"}>
              מיתוג ומסמכים
            </NavItem>
            ...
            {isAdmin && (
              <NavItem href="/settings/activity-log" active={pathname === "/settings/activity-log"}>
                יומן פעילות מערכת
              </NavItem>
            )}
          </div>
