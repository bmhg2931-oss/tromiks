...
const IN = "border border-line rounded-lg px-1.5 py-2 text-sm bg-white";
...
export default function HebrewGregorianDateField({
  ...
  return (
    <div>
      <label className="block text-xs font-semibold text-ink-soft mb-1">תאריך הצטרפות (לועזי ועברי)</label>
