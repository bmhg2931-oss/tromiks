...
export type OrgSettings = {
  ...
  report_header_note: string | null;
  report_signature: string | null;
  invoice_body_text: string | null;
...
export const CONTACT_FIELD_DEFS: ContactFieldDef[] = [
  ...
  { key: "spouse_name", label: "שם האשה", section: "כללי" },
  ...
  { key: "father_name", label: "שם האב", section: "פרטים נוספים" },
  { key: "father_in_law_name", label: "שם החותן", section: "פרטים נוספים" },
  { key: "notes", label: "הערות", section: "פרטים נוספים" },
  { key: "mailing_name", label: "שם לדיוור", section: "פרטים נוספים" },
  { key: "wife_id_number", label: "ת.ז. אישה", section: "סיווג במערכת" },
...
export const PAYMENT_HUBS = ["ישראל", "אנגליה", 'ארה"ב', "בלגיה", "שווייץ"];
